...
for ICON in $BASE_DIR/art/*.svg; do
	...
	convert -resize 36x36 $ICON $BASE_DIR/res/drawable-ldpi/$BASE_NAME.png
	convert -resize 48x48 $ICON $BASE_DIR/res/drawable-mdpi/$BASE_NAME.png
	convert -resize 72x72 $ICON $BASE_DIR/res/drawable-hdpi/$BASE_NAME.png
	convert -resize 96x96 $ICON $BASE_DIR/res/drawable-xhdpi/$BASE_NAME.png
